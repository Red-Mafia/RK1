...
-----------------------------------------------
\033[1;93m AUTHOR: RIAZKHAN
\033[1;93m Facebook:RIAZKHAN
\033[1;93m Fb Page:Riaz-hacked
\033[1;91m---------------------------------------------                           
...
def main():
    ...
    print("\033[1;95m[2]\033[1;97mFOLLOW RIAZKHAN ")
    ...
    print("\033[1;91m[0]\033[1;97mEXIT RK ")
...
def menu():
    ...
    print("\033[1;97m[0]\033[1;97mEXIT RK")
...
def menu_select():
	...
	print ("[!] itz RED-MAFIA Brand Total Cp/Ok : "+str(len(cps)) + "/"+str(len(oks)))
